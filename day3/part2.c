...
void compare_lines(char *prev, char *curr, char *next, int is_first, int is_last);
...
int main() {
    ...
    while (fgets(curr_line, sizeof(curr_line), file) != NULL) {
        ...
        if (fgets(next_line, sizeof(next_line), file) != NULL) {
            ...
            compare_lines(prev_line, curr_line, next_line, is_first, is_last);
            is_first = 0;
            ...
            while (1) {
                ...
                if (fgets(next_line, sizeof(next_line), file) == NULL) {
                    ...
                    is_last = 1;
                    compare_lines(prev_line, curr_line, "empty", is_first, is_last);
                    break;
                }
            ...
            is_last = 1;
            compare_lines("empty", curr_line, "empty", is_first, is_last);
        }
    }
